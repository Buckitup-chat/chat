defmodule Chat.Data.Schemas.ReviewRight do
  @moduledoc """
  Macro for generating review right Ecto schemas.
  ...
  defmacro __using__(opts) do
    ...
    table = "review_#{kind_str}_right"
    pkey_constraint = "review_#{kind_str}_right_pkey"

    sign_hash_type =
      Module.concat([Chat.Data.Types, :"Review#{String.capitalize(kind_str)}RightSignHash"])
    ...
    quote do
      ...
      schema unquote(table) do
        ...
        field(:sign_hash, unquote(sign_hash_type))
      end
      ...
      def create_changeset(right, attrs) do
        ...
        |> unique_constraint(:review_hash, name: unquote(pkey_constraint))
      end
