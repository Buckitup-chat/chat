defmodule Chat.Rooms do
  ...
  def parcel_to_indexed_message(parcel, room_identity \\ nil) do
    Chat.SignedParcel.message_type(parcel) == :room_message ||
      raise ArgumentError, "Parcel does not contain a room message"

    validate_room_identity!(parcel, room_identity)
    Chat.SignedParcel.extract_indexed_message(parcel)
  end

  defp validate_room_identity!(_parcel, nil), do: :ok

  defp validate_room_identity!(parcel, room_identity) do
