  ...
  def mount(_params, _session, socket) do
    case connected?(socket) do
      true ->
        ...
        shape =
          Electric.Client.ShapeDefinition.new!("review_list",
            parser: {Electric.Client.EctoAdapter, ReviewList}
          )
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
          ...
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold text-gray-900">Review Lists (Electric)</h1>
              <p class="mt-2 text-sm text-gray-600">Per-user encrypted lists of review passwords</p>
            </div>
        ...
        <%= if @loading do %>
          <div class="flex flex-col justify-center items-center py-12">
            ...
            <p class="mt-4 text-sm text-gray-600">Syncing review lists from Electric...</p>
          </div>
        <% else %>
          <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
              <h3 class="text-lg leading-6 font-medium text-gray-900">Review Lists Stream</h3>
            </div>
