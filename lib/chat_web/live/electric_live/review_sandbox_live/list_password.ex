defmodule ChatWeb.ElectricLive.ReviewSandboxLive.ListPassword do
  ...
  The password never rotates — "shared once, shared forever" (docs/proposal/reviews.md
  ...
  # crypt_skey, domain-separated per slot (docs/pq/electric/pq_data_layer/09_symmetric_keys.md).
