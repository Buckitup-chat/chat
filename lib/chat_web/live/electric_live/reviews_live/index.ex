defmodule ChatWeb.ElectricLive.ReviewsLive.Index do
                ...
                <div class="flex items-center justify-between">
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-gray-900 truncate">
                      Review:
                      <span class="font-mono text-xs">{truncate_hash(review.review_hash)}</span>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                      Origin: <span class="font-mono">{truncate_hash(review.origin_hash)}</span>
                    </p>
                    <p class="mt-1 text-xs text-gray-500">
                      Author: <span class="font-mono">{truncate_hash(review.author_hash)}</span>
  ...
  defp truncate_hash(<<prefix::binary-size(6), _::binary>>), do: prefix <> "..."
  defp truncate_hash(short) when is_binary(short), do: short
end
