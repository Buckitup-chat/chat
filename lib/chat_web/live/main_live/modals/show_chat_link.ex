defmodule ChatWeb.MainLive.Modals.ShowChatLink do
  @moduledoc "Displays qr and link of chat"
  ...
  def render(assigns) do
    ~H"""
    <div>
      <h1 class="text-base font-bold text-grayscale">Chat link</h1>
      ...
      <div class="flex flex-row">
        <input class="w-4/5 rounded-md" id="chat-url" type="text" value={@url} readonly />
        <button
          ...
          phx-click={
            JS.push("copy")
            |> JS.dispatch("phx:copy", to: "#chat-url")
