defmodule Chat.MessagingTest do
  ...
  describe "preload_content/2" do
    setup do
      ...
      secret = :crypto.strong_rand_bytes(32)  # Secret must be 32 bytes
    ...
    test "handles multiple messages of different types", %{create_test_message: create_test_message} do
      # Create messages of different types
      text_message = create_test_message.(:text, "Hello, world!")
      unknown_message = create_test_message.(:unknown, "some_content")
      
      # Process the messages
      processed_messages = Messaging.preload_content([text_message, unknown_message], fn _ -> %{} end)
